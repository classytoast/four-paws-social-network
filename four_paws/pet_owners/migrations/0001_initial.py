    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pet_owners.owner', verbose_name='автор поста')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('owner', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pet_owners.owner', verbose_name='владелец фото')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('follower', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='subscriptions', to='pet_owners.owner', verbose_name='подписчик')),
            ],
        ),
        migrations.AddField(
            model_name='animal',
        ...
        migrations.AddField(
            model_name='animal',
            name='pet_owner',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='pet_owners.owner', verbose_name='владелец'),
        ),
    ]
